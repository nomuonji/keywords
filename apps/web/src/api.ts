...
/** True when the UI runs against the deployed remote backend (Firestore reads only). */
export const isRemoteBackend = () => !['localhost', '127.0.0.1'].includes(window.location.hostname);
