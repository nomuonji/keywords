...
export function App(){
 ...
 useEffect(()=>{abortRef.current?.abort();setSnapshot(null);if(projectId){const nextView=nextProjectViewRef.current;nextProjectViewRef.current=null;setView(nextView??'home');void loadHome(projectId)}return()=>abortRef.current?.abort()},[projectId]);
