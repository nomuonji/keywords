...
app.post('/operations/:operationId/projects/:projectId/discovery', async c => c.json(await operationCommands.startDiscovery(ctx(c), { ...(await body(c)), operationId: c.req.param('operationId'), projectId: c.req.param('projectId') }), 201));
