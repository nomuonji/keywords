...
export function operatorInstructions(next: Record<string, unknown>) {
  ...
  return { objective, instructions: `${common}\n\n${instructions}`, measurementOnly: observation || measurement || inventory || siteOptimization,
